...
unsigned char xbuf[24];
	...
	xbuf[5] = (unsigned char)tsPtr->flags;
	xbuf[6] = (unsigned char)tsPtr->volume;
	xbuf[7] = (unsigned char)tsPtr->output;
	xbuf[8] = (unsigned char)tsPtr->function;
	xbuf[9] = (unsigned char)tsPtr->first;
	xbuf[10] = (unsigned char)(tsPtr->first >> 8);
	xbuf[11] = (unsigned char)tsPtr->last;
	xbuf[12] = (unsigned char)(tsPtr->last >> 8);
	xbuf[13] = 0x55;
